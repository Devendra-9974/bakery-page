...
import BirthdayCakes from "../assets/images/img/joy.jpg";
import PartyCakes from "../assets/images/img/butter2.jpg";
import FestivalSpecial from "../assets/images/img/festivalSpecial.jpg";
    ...
    <div className="bakery-homepage">
      ...
      <header className="hero" style={{ backgroundImage: `url(${heroImages[currentHeroImage]})` }}>
        <div className="hero-content">
          ...
          <a href="#best-sellers">Order Now</a>
        </div>
      </header>
      ...
      <section className="about" style={{ backgroundColor: "#f9f9f9", padding: "40px 0" }}>
        <div className="container">
          ...
          src={aboutUsImage} alt="About Sweet Cravings Bakery" className="about-img" /> */}
        </div>
      </section>
      ...
      <section className="menu-highlights" style={{ backgroundColor: "#fff", padding: "40px 0" }}>
        <div className="container">
          <h2 id="best-sellers">Our Bestsellers</h2>
          <p>Indulge in our most loved baked goods and freshly made with premium ingredients every day.</p>
          <div className="menu-items">
            <div className="menu-item">
              <Link to="/products/BirthdayCakes">
                <img src={BirthdayCakes} alt="Chocolate Delight" className="menu-item-img" />
                <h3>BirthdayCakes</h3>
                <p>Rich and decadent, our signature chocolate cake is a true crowd favorite!</p>
              </Link>
            </div>
            <div className="menu-item">
              <Link to="/products/PartyCakes">
                <img src={PartyCakes} alt="Buttery Croissants" className="menu-item-img" />
                <h3>PartyCakes</h3>
                <p>Golden, buttery layers that melt in your mouth — a French classic!</p>
              </Link>
            </div>
            <div className="menu-item">
              <Link to="/products/FestivalSpecial">
                <img src={FestivalSpecial} alt="Colorful Macarons" className="menu-item-img" />
                <h3>FestivalSpecial</h3>
      ...
      <section className="featured-recipes" style={{ padding: "40px 0", backgroundColor: "#fff" }}>
        <div className="container">
          <h2 id="fearec">Featured Recipes</h2>
          <p>Explore some of our most popular recipes, from decadent cakes to mouthwatering pastries.</p>
          <div className="recipes-container">
            <div className="recipe-item">
              <h3>Party Cake Recipe</h3>
              <p>Learn how to make our party Cakes at home with this step-by-step guide.</p>
              <Link to="https://www.youtube.com/shorts/LtzifStLLMM" className="recipe-link">See Recipe</Link>
            </div>
            <div className="recipe-item">
              <h3>Beautiful Cakes</h3>
              <p>Discover the art of making beautiful cakes at our youtube channel and show some love.</p>
              <Link to="https://www.youtube.com/shorts/is6GRzPHfIk" className="recipe-link">See Recipe</Link>
            </div>
            <div className="recipe-item">
              <h3>Nutella chocolate</h3>
              <p>learn to prepare nutella chcolates easily at home at our channel.</p>
              <Link to="https://www.youtube.com/shorts/Hy4zfVDGrBE" className="recipe-link">See Recipe</Link>
            </div>
          </div>
        </div>
      </section>
